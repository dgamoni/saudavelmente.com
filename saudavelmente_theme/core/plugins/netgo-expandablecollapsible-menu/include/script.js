jQuery(function($) {
	...
	$netgo_navigations.find("ul a").live("click", function(e, isFromLI) {
		...
		//fix add accordion effect
		var next_ul_current = $this.parent('li');
		var allPanels = $netgo_navigations.find("ul ul");
		//console.log(allPanels);
		allPanels.not(next_ul).slideUp();
		$netgo_navigations.find("ul li.current_arrow").not(next_ul_current).toggleClass('current_arrow');
		...
		//var sub = $this.closest("div.netgo_navigation").siblings(".sub-menu");
		//var sub = $("div.netgo_navigation .menu-item").siblings(".sub-menu");
		//console.log(sub);
		...
		if (do_expand) { 
			...
			if ($this.next("ul").length) {
				...
				//$(".netgo_navigation ul li.current_arrow ul").slideDown();
				//console.log($this.siblings());
				
				$this.next("ul:first").slideToggle("fast", function() {
						
				//console.log($this);
				$this.parent('li').toggleClass('current_arrow');
